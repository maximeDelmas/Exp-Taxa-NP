...
create_plot <- function(big.df, ref){
    ...
    data_for_plot <- sub.df %>% mutate(masked.rank.bin = cut(rank.in.masked, breaks = c(-1, 1, 2, 5, 10, 20, 50), labels = c('exclusive', "top 1", "top [2-5[", "top [5-10[", "top [10-20[", "top [20-50["), include.lowest = T, right = F))
    ...
    data_for_plot$masked.rank.bin <- factor(data_for_plot$masked.rank.bin, levels = c('exclusive', "top 1", "top [2-5[", "top [5-10[", "top [10-20[", "top [20-50["))
